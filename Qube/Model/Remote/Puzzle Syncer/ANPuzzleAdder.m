...
- (id)initWithDataManager:(ANDataManager *)aManager delegate:(id<ANPuzzleSyncerDelegate>)aDel {
    if ((self = [super initWithDataManager:aManager delegate:aDel])) {
        ...
        ANAPIAddRequest * addReq = [[ANAPIAddRequest alloc] initWithPuzzleAdditions:added];
...
- (void)handleConflictReplaceKeepLocal:(ANNameCollisionConflict *)conflict {
    ...
    ANAPIReplaceRequest * replace = [[ANAPIReplaceRequest alloc] initWithRemoteId:conflict.remotePuzzle.identifier
...
- (void)handleConflictRename:(ANNameCollisionConflict *)conflict locally:(BOOL)flag {
    ...
    if (flag) {
        ...
        ANAPIAddRequest * addReq = [[ANAPIAddRequest alloc] initWithPuzzles:@[conflict.localPuzzle]];
        [self sendAPICall:addReq returnSelector:@selector(addRequestResponse:)];
        ...
        ANAPIRenameAdd * call = [[ANAPIRenameAdd alloc] initWithRemoteId:conflict.remotePuzzle.identifier
